...
public class SSLRestClientMojoTest extends MojoTest {
    ...
    public static void beforeClassHook() {
        ...
        System.setProperty("spring.profiles.active", "1-way-tls");
    ...
    @Test
    public void testSkipSslVerification()
            throws Exception {
        File pom = new File("target/test/projects-to-test/skip-ssl-verification");
        assertNotNull(pom);
